...
double base_speed = 165; // 195-200-205-210-212.5-200-205.0-200-195
double motor_speed = base_speed;

int left_motor_speed;
int right_motor_speed;
//Thiết lập tốc độ rẽ, lùi
int banh_chinh = 50;//-135-100-110.0-90-100
int banh_phu = 50; //Đảo ngược-75-95-100.0-75-80-100
int toc_do_lui = 90;
//Thiết lập hệ số PID
double Kp = 16;    //7-15-20
double Ki = 0;
double Kd = 0.208;//0-7-16-20
...
void loop()
{
 ...
 // Serial.println(error);
  ...
  else
  {
    ...
    // DiThang();
    // analogWrite(ENA,165+20);//0.1-0.15
    // analogWrite(ENB,165-20);
}
